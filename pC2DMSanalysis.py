...
This module holds the classes required to produce a 2D-PC-MS map,
identify features and calculate their 2D-PC-MS correlation score,
given input of text file of a converted .raw file.
"""
