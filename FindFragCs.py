...
Extract charge states from 2D-PC-MS map.

Mass conservation lines are fundamentally different to neutral loss lines.
Hough transform should be able to find all
NL lines as well
"""
...
pointsIn=None #path to where 2D-PC-MS signals are saved
parMz=9999
parCs=9999
ionName='X_X+'
...
houghOnly=True
topN=100 # 
houghThresh=6 #how many points does m/c line have to pass through to be called
#a line?
